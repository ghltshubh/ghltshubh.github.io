...
$$SE_{\bar_{x}}$$ $$=$$ $${s^2}\over{n}$$ $$\implies$$ larger the sample size lower the variance.
...
$$SE_{\bar_{x}}$$ = sampling distribution standard deviation (not sample standard deviation).
